...
export function ConfirmModal({
  ...
  const buttonVariantStyles = {
    danger: 'bg-danger-600 hover:bg-danger-500',
    warning: 'bg-warning-600 hover:bg-warning-500',
    info: 'bg-primary-600 hover:bg-primary-500'
  };
      ...
      <div className="text-center">
        ...
        <div className="flex gap-3 justify-center">
          <button
            onClick={onClose}
            disabled={isLoading}
            className="px-4 py-2 rounded-lg bg-dark-700 hover:bg-dark-600 text-dark-100 transition-colors disabled:opacity-50"
          >
            {cancelText}
          </button>
          <button
